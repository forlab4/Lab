...
namespace project_vniia
{
    public partial class Form_System : Form
    {
        ...
        public static bool Nei = true;
        public static bool Gam = true;
        public static int nei_ = 0;
        public static int gam_ = 0;
                    ...
                    for (int i = 3; i < length; i++)
                    {
                        if (msg == "Добавить в таблицу")
                        {
                            ...
                            foreach (DataRow r in rows_)
                            {
                                ...
                                {
                                    if (r.ItemArray[1].ToString().Contains("85")&& Nei)
                                    {
                                        nei_ = i;
                                        Nei = false;
                                    }

                                    if (!r.ItemArray[1].ToString().Contains("85") && Gam)//(82)
                                    {
                                        gam_ = i;
                                        Gam = false;
                                    }
        ...
        public void S_prov(DataRowCollection rows)
        {
            ...
            foreach (DataRow row_ in rows)
            {
                ...
                if (length > 19)
                {
                    ...
                    if (row_.ItemArray[2].ToString().Contains("85") && row_.ItemArray[2].ToString().Contains("/"))//(row_.ItemArray[2].ToString().Contains("82") || row_.ItemArray[2].ToString().Contains("84")) )
                {
                        ...
                        for (int i = 1; i < length-2; i++)
                        {
                            ...
                            {
                                if ((i + 2 == gam_ || i + 2 > gam_) && i + 2 != nei_)
                                {
                                    row_new["Блок" + g] = row_.ItemArray[i + 2];
                                    g++;
                                }
                                else
                                {
                                    row_new1["Блок" + i] = row_.ItemArray[i + 2];
                                }
                            }
                        }
